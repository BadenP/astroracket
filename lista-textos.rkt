...
Neste mundo, as máquinas maliciosas conquistaram a Terra e você é o último humano que resta. Logo, a esperança da humanidade repousa em seus ombros! Sua missão é aprender Racket para conseguir uma nave espacial para retornar ao seu planeta. Estarei aqui para te ajudar nessa jornada! Vou te fornecer os fundamentos e iremos praticar exercícios para que você adquira o conhecimento necessário para completar sua missão.

Lembre-se: conhecimento é muito importante! Você precisa de pontos de conhecimento em Racket para conseguir uma nave robusta e ser capaz de derrotar as máquinas!
 
[sempre pressione a tecla enter para avançar]" "")

        ("Vamos começar a aprender sobre Racket, uma linguagem que suporta a programação funcional! Utilizaremos o conhecimento fornecido pela documentação da linguagem, então seja esperto e guarde este link para consultar as referências caso precise: https://docs.racket-lang.org/guide/to-scheme.html

A programação funcional é um paradigma de programação em que os programas são descritos com aplicação e composição de funções, ela evita mudança de estado e efeitos colaterais. Ou seja, não podemos alterar o valor das variáveis declaradas em Racket. Uma função é um conjunto de expressões que mapeia valores de entrada para valores de saída.
...
'(1 2 3 4 5)." remove-duplicados "Dica: lembre-se de lidar com casos base, como quando a lista está vazia ou tem apenas um elemento. Considere também a utilização das funções first e rest para acessar o início e o resto da lista." ((((1 1 2 2 2)) (1 2)) (((1 2 2 3 3 3 4)) (1 2 3 4)) (((5 5 5 5 2 2 10 1 1)) (5 2 10 1))))
        ...
        ("Muito bem, Astro! Chegamos ao fim da sua missão, você será recompensado por chegar até aqui! Chegou a hora de descobrirmos qual nave você conquistou para retornar para a Terra. Será que ela será capaz de te levar de volta ao seu mundo?
Espero que sim... " "")))
